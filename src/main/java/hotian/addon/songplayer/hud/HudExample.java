package hotian.addon.songplayer.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(SongPlayerAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
